...
/**
 * Returns true when the task title contains the query string (case-insensitive).
 * Always returns true when query is empty/null so the caller can compose it
 * cleanly with other predicates.
 */
